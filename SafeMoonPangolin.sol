...
contract SafeMoonPangolin is Context, IERC20, Ownable {
    ...
    string private _name = "SafeMoonPangolin";
    string private _symbol = "SAFEMOON(PNG)";
    ...
    constructor () public {
        ...
        IPangolinRouter _router = IPangolinRouter(0xE54Ca86531e17Ef3616d22Ca28b0D458b6C89106);
         // Create a pangolin pair for this new token
        pangolinPair = IPangolinFactory(_router.factory()).createPair(address(this), _router.WAVAX());
    ...
    function _transfer(
        ...
        // also, don't swap & liquify if sender is pangolin pair.
    ...
    function swapTokensForAvax(uint256 tokenAmount) private {
        // generate the pangolin pair path of token -> wavax
